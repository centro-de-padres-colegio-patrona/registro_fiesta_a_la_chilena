...
export function LoginScreen({ onGoogleLogin, error, loading }: LoginScreenProps) {
  return (
    <div 
      ...
      <div className="relative z-10 w-full max-w-md space-y-8">
        ...
        {error && (
          <Alert className="border-red-200 bg-red-50/90 backdrop-blur-sm">
            ...
            <AlertDescription className="text-red-700 montserrat-regular">
              {error}
            </AlertDescription>
          </Alert>
        )}
        ...
        <div className="space-y-4">
          <Button
            ...
            disabled={loading}
            className="w-full bg-blue-600 hover:bg-blue-700 text-white py-4 text-lg shadow-xl hover:shadow-2xl smooth-transition montserrat-semibold disabled:opacity-50 disabled:cursor-not-allowed"
          >
          ...
          <p className="text-center montserrat-light help-text text-gray-800 drop-shadow-sm">
            Inicia sesión con tu cuenta de Google registrada en el sistema
          </p>
        </div>
        ...
        {/* Nota sobre configuración de Google Auth */}
        <div className="bg-blue-50/90 border border-blue-200 rounded-lg p-4 backdrop-blur-sm">
          <p className="text-xs montserrat-light text-blue-700 text-center">
            <strong>Nota:</strong> Para completar la configuración de Google Auth, 
